...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/drupaltest?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost:3306/drupaltest?new_link=true');
  }
}
...
$civicrm_root = 'D:/drupal7/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'D:/drupal7\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '968bcbb5b3bd636faae22e76036dafc0');
}
...
// define( 'CIVICRM_MAIL_LOG', 'D:/drupal7\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
